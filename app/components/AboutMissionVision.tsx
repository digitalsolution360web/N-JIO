...
export default function AboutMissionVision() {
  return (
    <div className="space-y-0 font-sans">
      {/* About Us Section */}
      <section id="about" className="py-12 bg-slate-50 overflow-hidden">
        <div className="max-w-[1600px] mx-auto px-6 md:px-12 lg:px-24 flex flex-col lg:flex-row items-center gap-16 md:gap-32">
        ...
        <div className="max-w-[1600px] mx-auto px-6 md:px-12 lg:px-24">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20">
            <motion.div
              ...
              whileInView={{ opacity: 1, scale: 1 }}
              viewport={{ once: true }}
              className="bg-white/5 backdrop-blur-xl p-12 rounded-[3.5rem] border border-white/10 hover:border-amber-500/50 transition-all group"
            >
              ...
              <h3 className="text-4xl font-[900] mb-6">Our Mission</h3>
            ...
            <motion.div
              ...
              className="bg-white/5 backdrop-blur-xl p-12 rounded-[3.5rem] border border-white/10 hover:border-blue-500/50 transition-all group"
            >
              <div className="w-20 h-20 bg-blue-600 rounded-3xl flex items-center justify-center mb-10 shadow-2xl shadow-blue-500/20 group-hover:rotate-12 transition-transform">
                <Eye size={40} />
              </div>
              <h3 className="text-4xl font-[900] mb-6">Our Vision</h3>
              <p className="text-slate-400 text-xl leading-relaxed font-medium">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <motion.div
                key={idx}
                whileHover={{ y: -10 }}
                className="p-10 rounded-[2.5rem] bg-slate-50 hover:bg-white transition-all border border-slate-100 shadow-sm hover:shadow-2xl hover:shadow-slate-200/50 group"
              >
                <div className="w-16 h-16 bg-white rounded-2xl shadow-sm flex items-center justify-center text-amber-500 mb-8 mx-auto group-hover:bg-amber-500 group-hover:text-white transition-colors">
                  <Heart size={28} />
                </div>
                <h4 className="text-2xl font-[900] mb-4 text-slate-900">{item.title}</h4>
      ...
      <section className="pb-24 px-6 md:px-12">
        <div className="max-w-[1600px] mx-auto bg-[#0f172a] rounded-[3rem] p-8 md:p-14 text-white text-center shadow-2xl relative overflow-hidden border border-white/5">
          {/* Subtle Accents */}
          ...
          >
            <h2 className="text-4xl md:text-[60px] font-[900] leading-none tracking-tight">
