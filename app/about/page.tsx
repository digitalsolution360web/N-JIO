...
export default function AboutPage() {
  return (
    <div className="pt-[140px] pb-24 space-y-24 bg-white">
      {/* About Hero Section */}
        ...
        <div className="max-w-[1600px] mx-auto">
          <div className="flex flex-col lg:flex-row items-center gap-16 md:gap-24">
            <div className="lg:w-1/2 space-y-8">
              ...
              <h1 className="text-4xl md:text-[64px] font-[900] text-slate-900 leading-[1.05] tracking-tight">
      ...
      <section className="px-6 md:px-12 lg:px-24 pb-24">
        <div className="max-w-[1600px] mx-auto flex flex-col lg:flex-row-reverse items-center gap-16 md:gap-24">
          <div className="lg:w-1/2 space-y-8">
            <h2 className="text-5xl font-[900] text-slate-900 leading-tight">
